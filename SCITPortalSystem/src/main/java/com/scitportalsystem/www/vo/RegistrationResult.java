...
public class RegistrationResult {
	...
	public RegistrationResult(int registrationNum, int alumni, String classroom, String name, String id,
			String registrationContent, String estimatedTime, Date registrationDate, int deleteStatus, String deleteBy,
			Date deleteDate) {
		super();
	...
	public String toString() {
		return "RegistrationResult [registrationNum=" + registrationNum + ", alumni=" + alumni + ", classroom="
				...
				+ ", estimatedTime=" + estimatedTime + ", registrationDate=" + registrationDate + ", deleteStatus="
