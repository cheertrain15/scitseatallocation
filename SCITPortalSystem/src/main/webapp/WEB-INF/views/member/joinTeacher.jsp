...
<form action="joinTheTeacher" style="border:1px solid #ccc" method="post" enctype="multipart/form-data" onsubmit="return formCheck();">
<input type="hidden" name="memberClass" value="teacher">
  <div class="container">
  <br>
    <h1>Sign Up</h1><br>
