...
<title>설문조사 수정</title>
	...
	<script type="text/javascript" src="<c:url value='/resources/js/survey/surveyEdit.js' />"></script>
	<link rel="stylesheet" type="text/css" href="<c:url value='/resources/css/survey/surveyEdit.css' />">
