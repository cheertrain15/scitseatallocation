        ...
        <div class="container kill-vertical">
            ...
            <div class="unit social-unit one-third last footer--section-right">
                <ul class="social-icons">
                    <li><a href="https://www.facebook.com/iu.uits" target="_BLANK"><i class="fa fa-facebook"></i></a></li>
                    <li><a href="https://twitter.com/insideuits" target="_BLANK"><i class="fa fa-twitter"></i></a></li>
                    <li><a href="https://www.youtube.com/uitsatiu" target="_BLANK"><i class="fa fa-youtube"></i></a></li>
                    <li><a href="https://plus.google.com/109054154815294782478" target="_BLANK"><i class="fa fa-google-plus"></i></a></li>
                </ul>
                <p>
